...
captures, confirmed applicable across the crate rename in ADR 0020 and the
[evidence index](../docs/S12-evidence.md). Its completion persists independently
of the rename's fingerprint mismatch. Other sprint and experiment checks retain
their current-source requirements.
...
| S12 | Phase 0 gate | Recorded S02 to S10 milestones | ADR 0020 accepts the indexed E1 to E8 evidence and records go (2026-09-20) |
...
S04, S05 and S06 export clean copies into temporary directories and add access-only wrappers for private Go helpers; they never write to the canonical submodule. Scanner and parser/encoder parity use these clean native Go exports, independently of S03's patched extractor worktree. Future symbol and WebAssembly tools must declare their own source closure and bridge policy. See [S04](../docs/S04.md), [S05](../docs/S05.md) and [S06](../docs/S06.md) for reproduction and limits.
...
- **Decisions.** ADR 0019 (test-host protocol) and ADR 0020 (gate decision) were accepted after the owner's review, on 2026-09-19 and 2026-09-20 respectively. ADR 0020 confirms reuse of the recent captures across the crate rename for S12, preserving their original provenance.
