...
output=p5.ROOT/'target/s08/p5-corpus-display-recheck-04'
output.mkdir()
...
metadata={'selection':'All five remaining type/symbol failures from display-recheck-01; supplemental comparison, no new full-corpus count',
