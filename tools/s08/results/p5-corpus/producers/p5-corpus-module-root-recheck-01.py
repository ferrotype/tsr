...
p4=p5.p4
control=p5.ROOT/'target/s08/p5-corpus-display-recheck-01'
output=p5.ROOT/'target/s08/p5-corpus-module-root-recheck-01'
output.mkdir()
prior=p5.read(control/'report.json')
selected=[i for i,r in enumerate(prior['rows']) if r['state']=='different']
...
metadata={'selection':'All 95 completed-but-different rows from display-recheck-01; supplemental comparison, no new full-corpus count',
