...
p4=p5.p4
control=p5.ROOT/'target/s08/p5-corpus-return-recheck-01'
output=p5.ROOT/'target/s08/p5-corpus-default-recheck-01'
output.mkdir()
prior=p5.read(control/'report.json')
selected=[i for i,r in enumerate(prior['rows']) if r['id'].startswith('conformance/jsdoc/moduleExportsElementAccessAssignment.ts#')]
...
metadata={'selection':'CommonJS moduleExportsElementAccessAssignment variant from return-recheck-01; supplemental comparison, no new full-corpus count',
