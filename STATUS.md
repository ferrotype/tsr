...
| E2: Checker slice | checker_throughput | `run.checkerbench.throughput_ratio > 0` measured Rust/Go checker throughput on the frozen query workload; positive finite measurement, not a speed target | 0.411011138186872 | pass |
| E2: Checker slice | checker_allocated_bytes | `run.checkerbench.allocated_bytes_ratio >= 0` measured Rust/Go bytes allocated during the fixed checker query phase, with raw samples and a positive Go denominator | 0.7226982922796714 | pass |
| E2: Checker slice | checker_retained_bytes | `run.checkerbench.retained_bytes_ratio >= 0` measured Rust/Go retained bytes with the declared checker/result roots alive after the fixed query phase, with raw samples and a positive Go denominator | 1.4122196029905487 | pass |
...
| E5: Memory | peak_rss | `run.e5.peak_rss_ratio <= 0.85` Rust / Go peak RSS for parse and bind of the pinned VS Code workload | 0.6993321492745043 | pass |
| E5: Memory | allocated_bytes | `run.e5.allocated_bytes_ratio <= 0.85` Rust / Go bytes allocated for the same parse/bind workload | 0.7002796448317087 | pass |
| E5: Memory | type_footprint | `run.e5.type_footprint_ratio <= 0.8` Rust / Go per-type footprint on the frozen checker subset | 0.811623337650432 | fail |
| E6: CPU | one_thread | `run.e6.one_thread_wall_time_ratio <= 1.25` Rust / Go wall time at one thread | 1.191684970278891 | pass |
| E6: CPU | eight_threads | `run.e6.eight_threads_wall_time_ratio <= 1.45` Rust / Go wall time at eight threads | 1.3578683127980795 | pass |
...
| bindworkload | current | [result](status/evidence/d2142183f1b095995eb2f78328910e5b6cae6ed30bfb3bf6953e3b8a0db66d3b.json) |
| checkerbench | current | [result](status/evidence/a747400f61a092318f5fd17486c6d9cda149c8875ce3a57478e6432ec9cee09d.json) |
...
| e2 | current | [result](status/evidence/5b80d42c67ce8591eaf37da311bbfa3a629721a8b0ce212ad4c43e0028f3d1b7.json) |
...
| e5 | current | [result](status/evidence/408015fbeb12c2f558204c6778a2c651ee541704d6caf7a29a27cd59e82abc05.json) |
| e6 | current | [result](status/evidence/8aa8a08e73ec6dfd308d519dda0b21e840845a94ac5b35dc756813e3d14fa57f.json) |
...
| relater | current | [result](status/evidence/9b0c4533f6c6f5d994553769f81987ab214daa74ffe2bf4dca09fe22464391fb.json) |
