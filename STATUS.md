...
Generated by `cargo xtask status` on 2026-09-22 against upstream pin `1f70213d4922b434345f639b441681e470c7cfc1`. Do not edit. Implementation state is declared in the ledger; verification is derived from current evidence. Function counts measure mapping, not semantic completeness.
...
| Files ported / verified | 25 / 9 |
| Lines verified | 13360 of 291999 (4.6%) |
| Mapped upstream functions | 4600 of 11506 (40.0%) |
| Experiments passed | 1 of 8 |
| ADRs accepted | 22 of 22 |
...
| `tsr_scanner` | 4 | 4330 | 0.0% |
| `tsr_semver` | 2 | 712 | 0.0% |
| `tsr_sourcemap` | 6 | 1021 | 0.0% |
| `tsr_stringutil` | 7 | 5564 | 0.0% |
...
| `internal/bundled` | 28 | 25.0% |
| `internal/checker` | 2879 | 52.3% |
| `internal/collections` | 84 | 96.4% |
| `internal/compiler` | 340 | 21.2% |
| `internal/contentmapper` | 78 | 0.0% |
| `internal/core` | 178 | 52.2% |
| `internal/debug` | 5 | 100.0% |
| `internal/diagnostics` | 14 | 50.0% |
| `internal/diagnosticwriter` | 40 | 62.5% |
| `internal/evaluator` | 5 | 100.0% |
...
| `internal/glob` | 15 | 60.0% |
| `internal/ipc` | 44 | 0.0% |
| `internal/jsnum` | 39 | 100.0% |
| `internal/json` | 12 | 66.7% |
| `internal/jsonrpc` | 20 | 0.0% |
| `internal/locale` | 5 | 100.0% |
...
| `internal/module` | 105 | 44.8% |
| `internal/modulespecifiers` | 53 | 32.1% |
| `internal/nativepath` | 4 | 100.0% |
| `internal/osutil` | 4 | 50.0% |
| `internal/outputpaths` | 22 | 40.9% |
| `internal/packagejson` | 38 | 44.7% |
...
| `internal/scanner` | 158 | 99.4% |
| `internal/semver` | 25 | 0.0% |
| `internal/sourcemap` | 50 | 0.0% |
| `internal/spanmap` | 34 | 8.8% |
| `internal/stringutil` | 48 | 95.8% |
| `internal/symlinks` | 12 | 100.0% |
...
| `internal/tsoptions` | 196 | 61.7% |
| `internal/tspath` | 88 | 98.9% |
| `internal/vfs/cachedvfs` | 16 | 100.0% |
| `internal/vfs/internal` | 12 | 100.0% |
| `internal/vfs/iovfs` | 15 | 100.0% |
| `internal/vfs/osvfs` | 23 | 100.0% |
| `internal/vfs/trackingvfs` | 12 | 100.0% |
| `internal/vfs/vfsmatch` | 31 | 54.8% |
| `internal/vfs/wrapvfs` | 13 | 100.0% |
...
| E3: Ownership | owners_return_to_baseline | `run.e3.live_owner_delta == 0` maximum absolute live-owner delta in the seven S04 arena scenarios; full E3 also requires the separately gated program, checker, builder and API suites, whose final-drop assertions cover their retained roots | missing | pending |
| E3: Ownership | allocations_return_to_baseline | `run.e3.live_allocation_delta == 0` maximum absolute tracked-storage-allocation delta in the seven S04 arena scenarios; full E3 also requires the separately gated program, checker, builder and API suites with their own final-drop counter assertions; not malloc calls or RSS | missing | pending |
...
| E7: WebAssembly | parser_artifact_size | `run.e7.parser_artifact_size_ratio <= 0.3` Rust wasm32 / Go GOOS=js parser artifact bytes | missing | pending |
| E7: WebAssembly | parse_throughput | `run.e7.parse_throughput_ratio >= 1.5` Rust / Go parse throughput | missing | pending |
...
| E8: Embedding | node_parse_latency | `run.e8.node_parse_latency_ratio <= 0.4` Node in-process / --api socket parse-and-encode latency for a 10 KB file | missing | pending |
...
E7: Parser performance and checker-slice feasibility measured separately; full checking/emit parity and speed are not established. Parser size and throughput limits re-based by owner-approved ADR 0020 (2026-09-20) from 0.25 and 2.0.

E8: Separate Rust consumer feasibility and Node parse latency measured separately; full crate surface and workload budgets remain Phase 7 gates. Node parse latency limit re-based by owner-approved ADR 0020 (2026-09-20) from 0.10.

## Evidence

| Run | State | Artifact |
|---|---|---|
| binder | current | [result](status/evidence/18e142d01ce38d551c88fc025f46a34934b17b820c9182e25f7997bf57993b39.json) |
...
| clippy | current | [result](status/evidence/1139a58c2c3bd5afcdfbe91a672e1f5cff42f551afd819ea91888c0269c58ce5.json) |
| config | current | [result](status/evidence/6e314a89c01f1d48ba987c73c91879126df70c883e2c083f1e1f0b968fdedca8.json) |
| deny | current | [result](status/evidence/591ad73fa43511e46af99a450162caf7ec7638882f55a7f3176bdbd5ea64ff65.json) |
| e1 | current | [result](status/evidence/df8264588b903add090b14987510317a755eca2ca910c885b5669baf93cea6db.json) |
...
| e4 | stale: source, pin, command or inputs changed | [result](status/evidence/d3d8440cedd29da0a8ca8b103a9715a01e587f59d9d264cb3facc76d3014a0cf.json) |
...
| fmt | current | [result](status/evidence/dc47449558c50622bbab178a193f188aa62175a07b78e629065fd12cdc6a4d1a.json) |
| foundations | current | [result](status/evidence/7b3de4d9126825df4d776fdc42e6403de141edf11ba57035af208a9796b0a86f.json) |
| gen | current | [result](status/evidence/acbeb3f87b196daef46e774ba1a2b611a80dadcb7f71b6a5dd3b50b6b2f22da3.json) |
...
| selftest | current | [result](status/evidence/34efc9d73aae1391aeaf72661c9fda3d0eb0518cb6e705ed6185bc113aa1cd4a.json) |
| syntax | current | [result](status/evidence/82574aa7edcf13a3fb6f2fbe6a001e5edae86ad2ceef15bc43db18cb455fa1d2.json) |
| testhost | current | [result](status/evidence/52d848dc16df91c05bbd3d66d32a6b52a61d35b237264fa7ebc9a6256629367a.json) |
| workspace | current | [result](status/evidence/3e8b72258aae6ba4457d1ba29e8559bdb080daef946d262827b31eff6488db17.json) |
...
- [x] `run.foundations.leaves_prepared == true`
...
- [x] P1A-F1a Foundation leaf tests: core/collections, text/number, JSON, locale, diagnostics and library access
...
- [ ] `sprint.P1A.done == 1`
- [x] `run.foundations.inventory_complete == true`
- [x] `run.foundations.leaves_complete == true`
...
- [x] `run.config.direct_complete == true`
...
- [x] `run.gen.locale_complete == true`
...
- [x] P1B-F1b Foundation leaf implementations satisfy the exact required operation traces
- [ ] P1B-F2b Filesystem, snapshots, paths and both matching dialects satisfy their required traces
- [x] P1B-F3b All 309 config/options output identities and supplementary package/resolution cases pass
...
### S02 Toolchain, lints, dependency policy, CI (open)
...
### S04 Contract leaves: tsr_jsstring and tsr_arena (open)
...
- [ ] S04-1 tsr_jsstring: JsString with Utf8, Wtf8 and Raw classification, BOM decoding, sentinel-aware iteration and byte-slice reclassification (docs/design/text.md, sections 1 and 2)
- [ ] S04-2 tsr_jsstring helpers with Go's replacements: ToLowerJS, ToUpperJS, TruncateByRunes, LowerFirstChar and literal escaping
- [ ] S04-3 tsr_jsstring position maps: PositionMap for the API, the LSP converters, the ECMAScript and LSP line maps and the scanner's line/character conversion, each with its own rounding, clamping and panic behavior
- [ ] S04-4 tsr_arena ids and owners: NonZeroU64 NodeId and SymbolId, the never-reused arena counter with checked exhaustion, file, bundle and scratch owners, leases and release-mode import validation (docs/design/ownership.md, sections 2.1 to 2.3)
- [ ] S04-5 tsr_arena lazy storage: paged lazy arena published under one RwLock with miss recheck and page growth (section 2.4)
- [ ] S04-6 tsr_arena bundles: BundleOwner with non-owning cyclic links, released in every order
...
- [ ] S06-3 tsr_ast runtime: node data and flags, the utilities the parser needs, visitor, deep clone, precedence and subtree facts
...
- [ ] S07-2 tsr_core, tsr_tsoptions, tsr_module and tsr_vfs slices; the in-memory program host; pinned lib loading through tsr_bundled; unsupported operations fail explicitly and are listed in the slice manifest
...
| 0020 | ADR 0020: Phase 0 gate decision | Accepted |
