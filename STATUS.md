...
Generated by `cargo xtask status` on 2026-09-17 against upstream pin `1f70213d4922b434345f639b441681e470c7cfc1`. Do not edit. Implementation state is declared in the ledger; verification is derived from current evidence. Function counts measure mapping, not semantic completeness.
...
| E2: Checker slice | checker_throughput | `run.checkerbench.throughput_ratio > 0` measured Rust/Go checker throughput on the frozen query workload; positive finite measurement, not a speed target | 0.3283817118575795 | pass |
| E2: Checker slice | checker_allocated_bytes | `run.checkerbench.allocated_bytes_ratio >= 0` measured Rust/Go bytes allocated during the fixed checker query phase, with raw samples and a positive Go denominator | 0.8026068579900297 | pass |
| E2: Checker slice | checker_retained_bytes | `run.checkerbench.retained_bytes_ratio >= 0` measured Rust/Go retained bytes with the declared checker/result roots alive after the fixed query phase, with raw samples and a positive Go denominator | 1.412030792403052 | pass |
| E2: Checker slice | relater_prototype_parity | `run.relater.parity == 1` ID-based and arena-reference/interior-mutability relaters both match the pinned oracle over every frozen prototype case; no skipped cases | 0 | fail |
...
| E5: Memory | peak_rss | `run.e5.peak_rss_ratio <= 0.85` Rust / Go peak RSS for parse and bind of the pinned VS Code workload | 0.6994213948850061 | pass |
| E5: Memory | allocated_bytes | `run.e5.allocated_bytes_ratio <= 0.85` Rust / Go bytes allocated for the same parse/bind workload | 0.7002796492249345 | pass |
| E5: Memory | type_footprint | `run.e5.type_footprint_ratio <= 0.8` Rust / Go per-type footprint on the frozen checker subset | 0.7907120481009079 | pass |
| E6: CPU | one_thread | `run.e6.one_thread_wall_time_ratio <= 1.25` Rust / Go wall time at one thread | 1.2006355687270989 | pass |
| E6: CPU | eight_threads | `run.e6.eight_threads_wall_time_ratio <= 1.45` Rust / Go wall time at eight threads | 1.3889666034016257 | pass |
...
| Run | State | Artifact |
|---|---|---|
| binder | stale: source, pin, command or inputs changed | [result](status/evidence/23455566ea5e8e057029319b3782d1f8d0b67c5e2e8e9ef14eb57f4c620cb536.json) |
| bindworkload | current | [result](status/evidence/2d7dcd52dcd055bae8683dd328c633bd9b495b29910952abaa7f6b5e396a1863.json) |
| checkerbench | current | [result](status/evidence/419a9a93797049caf708f4a2e9683375ee3083b4ebac9592846bd07bd532fb1c.json) |
...
| e1 | stale: source, pin, command or inputs changed | [result](status/evidence/ea4697799885757d0612fccfe7f06106baec8120ba6913f83b5fa0ab9b6ff0b6.json) |
| e2 | current | [result](status/evidence/1dafa704396ee4d03e6ce838a5b2725a4737284aaaed025fcee831e03a76f77f.json) |
...
| e4 | stale: source, pin, command or inputs changed | [result](status/evidence/204084c28a150b4f1020e535d6f984edb2cb746e9fd8f152a5206b01067eb75c.json) |
| e5 | current | [result](status/evidence/9e127f14a43dcfffe8ead1ae9a352c9c67e4b9c45665a9743f2c6ff2746db4d9.json) |
| e6 | current | [result](status/evidence/8795a087bd9b0e61146714b2459b63f08a170706007d00054c89f502ffb82cbb.json) |
...
| relater | current | [result](status/evidence/408f20ed09f330a4d1eb4baa2dc5a916d6bcfa3851377deaebe5f614db4c787a.json) |
