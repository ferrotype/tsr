...
Generated by `cargo xtask status` on 2026-09-14 against upstream pin `1f70213d4922b434345f639b441681e470c7cfc1`. Do not edit. Implementation state is declared in the ledger; verification is derived from current evidence. Function counts measure mapping, not semantic completeness.
...
| Files ported / verified | 23 / 17 |
| Lines verified | 9484 of 291999 (3.2%) |
| Mapped upstream functions | 3673 of 11506 (31.9%) |
| Experiments passed | 2 of 8 |
...
| `internal/checker` | 2879 | 51.4% |
| `internal/collections` | 84 | 0.0% |
| `internal/compiler` | 340 | 18.5% |
...
| E2: Checker slice | types_parity | `run.e2.types_parity == 1` matching .types outcomes / E2 acceptance variants | 0.9706478813107056 | fail |
| E2: Checker slice | errors_parity | `run.e2.errors_parity == 1` matching .errors.txt outcomes / E2 acceptance variants | 0.967552566976198 | fail |
...
| E2: Checker slice | divergences_approved | `run.e2.divergences_approved == true` every baseline difference the comparison accepts is covered by an owner-approved entry in data/divergences.toml (ADR 0004) | false | fail |
...
| Run | State | Artifact |
|---|---|---|
| binder | current | [result](status/evidence/23455566ea5e8e057029319b3782d1f8d0b67c5e2e8e9ef14eb57f4c620cb536.json) |
...
| checkertext | current | [result](status/evidence/f23266e101887be031094148400fa5cd7275718f470d152044dee9d6d598ae2a.json) |
| clippy | current | [result](status/evidence/ec8f9df9094ef651d75450b217fa22544540200f3464c63c43d422edc7324b16.json) |
| deny | current | [result](status/evidence/a7ff011459d1ab4cf82c427c17cc02bfe2ef717fb633b510ff8e3290baee67f1.json) |
| e1 | current | [result](status/evidence/ea4697799885757d0612fccfe7f06106baec8120ba6913f83b5fa0ab9b6ff0b6.json) |
| e2 | current | [result](status/evidence/8afcc2bf3237f452841e29cdd74a7a4c63c874afe8f6671483fb7f8a13c96c85.json) |
| e3 | current | [result](status/evidence/24d820d716a24a1bc11949e6ca6de90e9b235f99d4a40c7adf095bb8ec4e1ddd.json) |
...
| fmt | current | [result](status/evidence/2c360131f1eaeda760eeeccf67f7dcf603943bd14b7794c4533f9dc331bde47b.json) |
...
| program | current | [result](status/evidence/00814e46d2db7d3bb7ae9928a9812d8050484cb15fc01a3a4705144ab76dad05.json) |
| scanner | current | [result](status/evidence/519c36d88600c6257ecdae96e00698f6ca4639c48e233fab391d999a12ec2fae.json) |
| selftest | current | [result](status/evidence/163b27a666508309962f8759af73fef3723355bfa25c881af2d48c7f6321e79e.json) |
| workspace | current | [result](status/evidence/eed06f93dd2b7cfbe5bb3ce817fd670b5e4de87de7585d2dd8792be9fd674060.json) |
