...
| Mapped upstream functions | 4908 of 11506 (42.7%) |
...
| checker | stale: source, pin, command or inputs changed | [result](status/evidence/96b7c65f5f42d1eb95e5137360a15c95d7dcac7e47c2654bd3c822a4a675b1b6.json) |
...
### P2A Phase 2 stage A: the full checker acceptance contract (open)
...
- [ ] `run.checker.inventory_frozen == true` (unknown metric)
- [ ] `run.checker.native_verified == true` (unknown metric)
- [ ] `run.checker.harness_valid == true` (unknown metric)
- [ ] `run.checker.result_recorded == true` (unknown metric)
- [ ] `run.checker.blockers_named == true` (unknown metric)

Items:

- [ ] P2A-C0 C0: inventory, native contract, categorized Rust run, blockers and wiring
...
- [ ] `run.checker.unsupported_required == 0` (unknown metric)
