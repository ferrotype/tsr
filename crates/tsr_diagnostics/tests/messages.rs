use tsr_diagnostics::{by_code, by_key, Category, MESSAGES};
...
fn preserves_pinned_names_keys_categories_and_extra_messages() {
    let identifier = tsr_diagnostics::Identifier_expected;
    ...
    let extra = tsr_diagnostics::X_4_unless_singleThreaded_is_passed;
    ...
    let placeholder = tsr_diagnostics::Type_0_is_not_assignable_to_type_1;
    assert_eq!(
        placeholder.text,
