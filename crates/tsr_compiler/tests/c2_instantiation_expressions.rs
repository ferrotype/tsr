//! C2.3: instantiate retained expression types using their enclosing parameters.
...
const REQUESTS: &str = include_str!("fixtures/c2/instantiation_expressions/requests.json");
const OBSERVATIONS: &str = include_str!("fixtures/c2/instantiation_expressions/observations.json");
const PROVENANCE: &str = include_str!("fixtures/c2/instantiation_expressions/provenance.json");

#[test]
fn recursive_instantiation_expression_types_match_native() {
